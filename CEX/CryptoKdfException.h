...
public:
	...
	CryptoKdfException(const std::string &Origin, const std::string &Message, ErrorCodes ErrorCode);
	...
	/// <param name="Detail">The inner exception string</param>
	/// <param name="ErrorCode">The error code enumeral</param>
	CryptoKdfException(const std::string &Origin, const std::string &Message, const std::string &Detail, ErrorCodes ErrorCode);
