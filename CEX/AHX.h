...
/// <item><description>The HKDF Digest engine is definable through the <see cref="AHX(uint, Digests)">Constructor</see> type enumeration parameter: Digest.</description></item>
