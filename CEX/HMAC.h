...
/// <item><description>Thye input block size is the underlying hash functions internal input rate-size in bytes.</description></item>
...
public:
	...
	explicit HMAC(SHA2Digests DigestType);
