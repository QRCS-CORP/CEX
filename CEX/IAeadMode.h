...
public:
	...
	/// <para>Must be no greater then the MAC functions output size, and no less than the minimum Tag size.</para></param>
	///
	...
	virtual void Finalize(std::vector<byte> &Output, const size_t Offset, const size_t Length) = 0;
