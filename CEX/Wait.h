...
{
public:
	CallStackWithNr(char const* i, uint n, CallStack const* p) : CallStack(i, p), m_nr(n) {}
...
public:
	...
	class Err : public CryptoException
	{
	public:
		//Err(const std::string& s) : CryptoException(IO_ERROR, s) {}
	};
