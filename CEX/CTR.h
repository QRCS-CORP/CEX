...
/// <para>The CTR Counter mode generates a key-stream by encrypting successive values of an incrementing Big Endian ordered 8-bit integer counter array. \n
...
/// <list type="bullet">
/// <item><description>In CTR mode, Encryption/Decryption can both be pipelined (AVX, AVX2, or AVX512), and multi-threaded.</description></item>
...
private:
	...
	class CtrState;
	std::unique_ptr<CtrState> m_ctrState;
...
private:
	...
	void Encrypt(const std::vector<uint8_t> &Input, size_t InOffset, std::vector<uint8_t> &Output, size_t OutOffset);
