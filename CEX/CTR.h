...
/// In parallel mode, the CTR modes counter is increased by a number factored from the number of message blocks (ParallelBlockSize), allowing for counter pre-calculation and multi-threaded processing.<BR></BR>
...
public:
	...
	/// </summary>
	std::vector<byte> &Nonce() { return m_ctrVector; }
