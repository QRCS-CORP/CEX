...
/// In parallel mode, the CTR modes counter is increased by a number factored from the number of message blocks (ParallelBlockSize), allowing for counter pre-calculation and multi-threaded processing.<br>
...
public:
	...
	/// </summary>
	virtual const std::string Name() { return "CTR"; }
