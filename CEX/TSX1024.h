...
/// TSX1024 cipher(StreamAuthenticators::HMACSHA256);
...
/// The supported MAC generator options for TSX1024 are Poly1305, HMAC(SHA2-256/512), and the Keccak based KMAC-256, KMAC-512, and the experimental KMAC-1024.</para>
///
...
/// <item><description>In authenticated mode, the internal keys generated by cSHAKE will be unique with each MAC generator, each authentication option should be considered a seperate and distinct variant of the cipher, for example, TSX1024-SHAKE512 or TSX0124-HMAC512</description></item>
...
public:
	...
	/// The default authenticator parameter in TSX1024 is KMAC1024; valid options are, None, HMACSHA256, HMACSHA512, KMAC256, KMAC512, and KMAC1024.</para>
	/// </summary>
	/// 
	/// <param name="AuthenticatorType">The authentication engine, the default is KMAC1024</param>
	explicit TSX1024(StreamAuthenticators AuthenticatorType = StreamAuthenticators::KMAC1024);
