...
// This cipher is based on the TSX1024 stream cipher designed by Daniel J. Bernstein:
// TSX1024: <a href="http://www.ecrypt.eu.org/stream/salsa20pf.html"/>.
// 
// Implementation Details:
// TSX1024: An implementation if the TSX1024 implemented as a stream cipher
...
/// The supported MAC generator options for TSX1024 are HMAC(SHA2-256/512), and the Keccak based KMAC-256, KMAC-512, and the experimental KMAC-1024.</para>
///
...
private:
	...
	static void Generate(std::unique_ptr<TSX1024State> &State, std::array<ulong, 2> &Counter, std::vector<byte> &Output, const size_t OutOffset, const size_t Length);
