...
// ChaChaP20: An implementation of the ChaCha stream cipher
...
/// <summary>
/// A parallelized and vectorized ChaCha-256 20-round stream cipher [ChaChaP20] implementation.
/// <para>Uses an optional authentication mode; KMAC-256 enabled through the constructor to authenticate the stream.</para>
/// </summary>
/// 
/// <example>
...
/// The implementation is further parallelized by constructing a larger 'staggered' counter array, and processing large blocks using 128, 256, or 512-bit SIMD instructions.</para>
/// 
...
/// <item><description>This cipher is capable of authentication by setting the constructors Authenticate parameter to true, enabling KMAC-256 authentication.</description></item>
...
/// </list>
/// </remarks>
class ChaChaP20 final : public IStreamCipher
{
private:
...
public:
	...
	/// </summary>
	ChaChaP20(const ChaChaP20&) = delete;

	/// <summary>
	/// Copy operator: copy is restricted, this function has been deleted
	/// </summary>
	ChaChaP20& operator=(const ChaChaP20&) = delete;
	...
	explicit ChaChaP20(bool Authenticate);
