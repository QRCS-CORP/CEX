...
/// </summary>
class CryptoMacException : public CryptoException
{
public:
	...
	CryptoMacException(const std::string &Location, const std::string &Origin, const std::string &Message, ErrorCodes ErrorCode);
