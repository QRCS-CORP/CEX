#ifndef _CEX_CRYPTOGENERATOREXCEPTION_H
#define _CEX_CRYPTOGENERATOREXCEPTION_H
...
public:
	...
	/// <param name="Message">A custom message or error data</param>
	explicit CryptoGeneratorException(const std::string &Origin, const std::string &Message)
		:
		m_details(""),
		m_message(Message),
		m_origin(Origin)
	...
	explicit CryptoGeneratorException(const std::string &Origin, const std::string &Message, const std::string &Detail)
		:
		m_details(Detail),
		m_message(Message),
		m_origin(Origin)
