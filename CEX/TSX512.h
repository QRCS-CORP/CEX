...
// This cipher is based on the TSX512 stream cipher designed by Daniel J. Bernstein:
// TSX512: <a href="http://www.ecrypt.eu.org/stream/salsa20pf.html"/>.
// 
// Implementation Details:
// TSX512: An implementation if the TSX512 implemented as a stream cipher
...
/// The supported MAC generator options for TSX512 are HMAC(SHA2-256/512), and the Keccak based KMAC-256, and KMAC-512.</para>
///
...
private:
	...
	static void Generate(std::unique_ptr<TSX512State> &State, std::array<ulong, 2> &Counter, std::vector<byte> &Output, const size_t OutOffset, const size_t Length);
