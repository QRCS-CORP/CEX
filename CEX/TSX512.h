...
/// <item><description>Authentication using KMAC-512, can be invoked by setting the Authenticate parameter in the constructor.</description></item>
...
public:
	...
	/// The default authenticator parameter in Threefish-512 is KMAC512; valid options are, None, HMACSHA2256, HMACSHA2512, KMAC256, and KMAC512.</para>
	/// </summary>
	/// 
	...
	explicit TSX512(bool Authenticate);
