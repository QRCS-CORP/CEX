...
void DLTMK6Q8380417N256::Generate(std::vector<uint8_t> &PublicKey, std::vector<uint8_t> &PrivateKey, std::unique_ptr<Prng::IPrng> &Rng)
{
...
void DLTMK6Q8380417N256::Sign(std::vector<uint8_t> &Signature, const std::vector<uint8_t> &Message, const std::vector<uint8_t> &PrivateKey, std::unique_ptr<Prng::IPrng> &Rng)
{
	std::vector<uint8_t> rho(DILITHIUM_SEED_SIZE);
	std::vector<uint8_t> tr(DILITHIUM_CRH_SIZE);
	std::vector<uint8_t> key(DILITHIUM_SEED_SIZE);
...
bool DLTMK6Q8380417N256::Verify(std::vector<uint8_t> &Message, const std::vector<uint8_t> &Signature, const std::vector<uint8_t> &PublicKey)
{
	std::vector<std::vector<std::array<uint32_t, 256>>> mat(DILITHIUM_K, std::vector<std::array<uint32_t, 256>>(DILITHIUM_L));
	std::vector<std::array<uint32_t, 256>> t1(DILITHIUM_K);
	std::vector<std::array<uint32_t, 256>> w1(DILITHIUM_K);
...
void DLTMK6Q8380417N256::XOF(const std::vector<uint8_t> &Input, size_t InOffset, size_t InLength, std::vector<uint8_t> &Output, size_t OutOffset, size_t OutLength, size_t Rate)
{
