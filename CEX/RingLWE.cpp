...
AsymmetricKeyPair* RingLWE::Generate()
{
	...
	AsymmetricKey* apk = new AsymmetricKey(pk, AsymmetricPrimitives::RingLWE, AsymmetricKeyTypes::CipherPublicKey, static_cast<AsymmetricTransforms>(m_rlweParameters));
	AsymmetricKey* ask = new AsymmetricKey(sk, AsymmetricPrimitives::RingLWE, AsymmetricKeyTypes::CipherPrivateKey, static_cast<AsymmetricTransforms>(m_rlweParameters));
