...
private:
	...
	static const int NTRUP_P = 857;
	static const int NTRUP_Q = 5167;
	static const int NTRUP_W = 322;
	static const int NTRUP_ROUNDED = 1152;
	static const int NTRUP_RQ = 1322;
