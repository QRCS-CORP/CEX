...
public:
	...
	/// <param name="ShakeMode">The underlying SHAKE instance type</param>
	...
	explicit CSR(ShakeModes ShakeMode = ShakeModes::SHAKE256, Providers SeedEngine = Providers::ACP, size_t BufferSize = 1024);
	...
	explicit CSR(std::vector<byte> Seed, ShakeModes ShakeMode = ShakeModes::SHAKE256, size_t BufferSize = 1024);
