...
private:
	...
	static const size_t BLOCK_SIZE = 128; // TODO: replace with Skein class constants
...
private:
	...
	void Initialize();
	void LoadState(Skein1024State &State, std::array<ulong, 16> &Config);
	void Permute(std::array<ulong, 16> &Message, Skein1024State &State);
