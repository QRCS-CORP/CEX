...
void Threefish::PemuteP256C(const std::array<ulong, 4> &Key, const std::array<ulong, 2> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 4> &State, size_t Rounds)
{
	std::array<ulong, 4> C;
	std::array<ulong, 5> K;
	std::array<ulong, 3> T;
	...
	MemUtils::SetValue(C, 2, 2 * sizeof(ulong), 0xFF);
	MemUtils::Copy(Key, 0, K, 0, 4 * sizeof(ulong));
	...
	for (i = 0; i < r; ++i)
	{
		...
		x != 0 ? x -= 1 : x += 4;
		C[0] += C[1] + K[x];
		C[1] = IntUtils::RotL64(C[1], 14) ^ C[0];
		// mix
		x > 1 ? x -= 2 : x += 3;
		C[3] += K[x] + (i * 2);
		x > 0 ? x -= 1 : x += 4;
		y != 2 ? y += 1 : y -= 2;
		C[2] += C[3] + K[x] + T[y];
		C[3] = IntUtils::RotL64(C[3], 16) ^ C[2];
		C[0] += C[3];
		C[3] = IntUtils::RotL64(C[3], 52) ^ C[0];
		C[2] += C[1];
		C[1] = IntUtils::RotL64(C[1], 57) ^ C[2];
		C[0] += C[1];
		C[1] = IntUtils::RotL64(C[1], 23) ^ C[0];
		C[2] += C[3];
		C[3] = IntUtils::RotL64(C[3], 40) ^ C[2];
		C[0] += C[3];
		C[3] = IntUtils::RotL64(C[3], 5) ^ C[0];
		C[2] += C[1];
		C[1] = IntUtils::RotL64(C[1], 37) ^ C[2];
		// inject
		C[1] += K[x] + T[y];
		x != 0 ? x -= 1 : x += 4;
		C[0] += C[1] + K[x];
		C[1] = IntUtils::RotL64(C[1], 25) ^ C[0];
		// mix
		x > 1 ? x -= 2 : x += 3;
		C[3] += K[x] + (i * 2) + 1;
		x != 0 ? x -= 1 : x += 4;
		y != 2 ? y += 1 : y -= 2;
		C[2] += C[3] + K[x] + T[y];
		C[3] = IntUtils::RotL64(C[3], 33) ^ C[2];
		C[0] += C[3];
		C[3] = IntUtils::RotL64(C[3], 46) ^ C[0];
		C[2] += C[1];
		C[1] = IntUtils::RotL64(C[1], 12) ^ C[2];
		C[0] += C[1];
		C[1] = IntUtils::RotL64(C[1], 58) ^ C[0];
		C[2] += C[3];
		C[3] = IntUtils::RotL64(C[3], 22) ^ C[2];
		C[0] += C[3];
		C[3] = IntUtils::RotL64(C[3], 32) ^ C[0];
		C[2] += C[1];
		C[1] = IntUtils::RotL64(C[1], 32) ^ C[2];
	}
...
void Threefish::PemuteR72P256U(const std::array<ulong, 4> &Key, const std::array<ulong, 2> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 4> &State)
{
	ulong C0;
	ulong C1;
	ulong C2;
	...
	C1 += K1 + T0;
	C0 += C1 + K0;
	C1 = IntUtils::RotL64(C1, 14) ^ C0;
	// mix
	C3 += K3;
	C2 += C3 + K2 + T1;
	C3 = IntUtils::RotL64(C3, 16) ^ C2;
	C0 += C3;
	C3 = IntUtils::RotL64(C3, 52) ^ C0;
	C2 += C1;
	C1 = IntUtils::RotL64(C1, 57) ^ C2;
	C0 += C1;
	C1 = IntUtils::RotL64(C1, 23) ^ C0;
	C2 += C3;
	C3 = IntUtils::RotL64(C3, 40) ^ C2;
	C0 += C3;
	C3 = IntUtils::RotL64(C3, 5) ^ C0;
	C2 += C1;
	C1 = IntUtils::RotL64(C1, 37) ^ C2;
	// inject
	C1 += K2 + T1;
	C0 += C1 + K1;
	C1 = IntUtils::RotL64(C1, 25) ^ C0;
	// mix
	C3 += K4 + 1;
	C2 += C3 + K3 + T2;
	C3 = IntUtils::RotL64(C3, 33) ^ C2;
	C0 += C3;
	C3 = IntUtils::RotL64(C3, 46) ^ C0;
	C2 += C1;
	C1 = IntUtils::RotL64(C1, 12) ^ C2;
	C0 += C1;
	C1 = IntUtils::RotL64(C1, 58) ^ C0;
	C2 += C3;
	C3 = IntUtils::RotL64(C3, 22) ^ C2;
	C0 += C3;
	C3 = IntUtils::RotL64(C3, 32) ^ C0;
	C2 += C1;
	C1 = IntUtils::RotL64(C1, 32) ^ C2;
	// rounds 8-15
	C1 += K3 + T2;
	C0 += C1 + K2;
	C1 = IntUtils::RotL64(C1, 14) ^ C0;
...
void Threefish::PemuteP4x256H(const std::array<ulong, 4> &Key, const std::array<ulong, 8> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 16> &State, size_t Rounds)
{
...
void Threefish::PemuteP512C(const std::array<ulong, 8> &Key, const std::array<ulong, 2> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 8> &State, size_t Rounds)
{
	std::array<ulong, 8> C;
	std::array<ulong, 9> K;
	std::array<ulong, 3> T;
	...
	MemUtils::SetValue(C, 2, 6 * sizeof(ulong), 0xFF);
	MemUtils::Copy(Counter, 0, C, 0, 2 * sizeof(ulong));
	MemUtils::Copy(Key, 0, K, 0, 8 * sizeof(ulong));
	...
	for (i = 0; i < r; ++i)
	{
		...
		x != 0 ? x -= 1 : x += 8;
		C[0] += C[1] + K[x];
		C[1] = IntUtils::RotL64(C[1], 46) ^ C[0];
		x < 6 ? x += 3 : x -= 6;
		C[3] += K[x];
		x != 0 ? x -= 1 : x += 8;
		C[2] += C[3] + K[x];
		C[3] = IntUtils::RotL64(C[3], 36) ^ C[2];
		x < 6 ? x += 3 : x -= 6;
		C[5] += K[x] + T[y];
		x != 0 ? x -= 1 : x += 8;
		C[4] += C[5] + K[x];
		C[5] = IntUtils::RotL64(C[5], 19) ^ C[4];
		// mix
		x < 6 ? x += 3 : x -= 6;
		C[7] += K[x] + (i * 2);
		x != 0 ? x -= 1 : x += 8;
		y != 2 ? y += 1 : y -= 2;
		C[6] += C[7] + K[x] + T[y];
		C[7] = IntUtils::RotL64(C[7], 37) ^ C[6];
		C[2] += C[1];
		C[1] = IntUtils::RotL64(C[1], 33) ^ C[2];
		C[4] += C[7];
		C[7] = IntUtils::RotL64(C[7], 27) ^ C[4];
		C[6] += C[5];
		C[5] = IntUtils::RotL64(C[5], 14) ^ C[6];
		C[0] += C[3];
		C[3] = IntUtils::RotL64(C[3], 42) ^ C[0];
		C[4] += C[1];
		C[1] = IntUtils::RotL64(C[1], 17) ^ C[4];
		C[6] += C[3];
		C[3] = IntUtils::RotL64(C[3], 49) ^ C[6];
		C[0] += C[5];
		C[5] = IntUtils::RotL64(C[5], 36) ^ C[0];
		C[2] += C[7];
		C[7] = IntUtils::RotL64(C[7], 39) ^ C[2];
		C[6] += C[1];
		C[1] = IntUtils::RotL64(C[1], 44) ^ C[6];
		C[0] += C[7];
		C[7] = IntUtils::RotL64(C[7], 9) ^ C[0];
		C[2] += C[5];
		C[5] = IntUtils::RotL64(C[5], 54) ^ C[2];
		C[4] += C[3];
		C[3] = IntUtils::RotL64(C[3], 56) ^ C[4];
		// inject
		x > 3 ? x -= 4 : x += 5;
		C[1] += K[x];
		x != 0 ? x -= 1 : x += 8;
		C[0] += C[1] + K[x];
		C[1] = IntUtils::RotL64(C[1], 39) ^ C[0];
		x < 6 ? x += 3 : x -= 6;
		C[3] += K[x];
		x != 0 ? x -= 1 : x += 8;
		C[2] += C[3] + K[x];
		C[3] = IntUtils::RotL64(C[3], 30) ^ C[2];
		x < 6 ? x += 3 : x -= 6;
		C[5] += K[x] + T[y];
		x != 0 ? x -= 1 : x += 8;
		C[4] += C[5] + K[x];
		C[5] = IntUtils::RotL64(C[5], 34) ^ C[4];
		// mix
		x < 6 ? x += 3 : x -= 6;
		C[7] += K[x] + (i * 2) + 1;
		x != 0 ? x -= 1 : x += 8;
		y != 2 ? y += 1 : y -= 2;
		C[6] += C[7] + K[x] + T[y];
		C[7] = IntUtils::RotL64(C[7], 24) ^ C[6];
		C[2] += C[1];
		C[1] = IntUtils::RotL64(C[1], 13) ^ C[2];
		C[4] += C[7];
		C[7] = IntUtils::RotL64(C[7], 50) ^ C[4];
		C[6] += C[5];
		C[5] = IntUtils::RotL64(C[5], 10) ^ C[6];
		C[0] += C[3];
		C[3] = IntUtils::RotL64(C[3], 17) ^ C[0];
		C[4] += C[1];
		C[1] = IntUtils::RotL64(C[1], 25) ^ C[4];
		C[6] += C[3];
		C[3] = IntUtils::RotL64(C[3], 29) ^ C[6];
		C[0] += C[5];
		C[5] = IntUtils::RotL64(C[5], 39) ^ C[0];
		C[2] += C[7];
		C[7] = IntUtils::RotL64(C[7], 43) ^ C[2];
		C[6] += C[1];
		C[1] = IntUtils::RotL64(C[1], 8) ^ C[6];
		C[0] += C[7];
		C[7] = IntUtils::RotL64(C[7], 35) ^ C[0];
		C[2] += C[5];
		C[5] = IntUtils::RotL64(C[5], 56) ^ C[2];
		C[4] += C[3];
		C[3] = IntUtils::RotL64(C[3], 22) ^ C[4];
		x > 3 ? x -= 4 : x += 5;
	}
...
void Threefish::PemuteR96P512U(const std::array<ulong, 8> &Key, const std::array<ulong, 2> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 8> &State)
{
	ulong C0;
	ulong C1;
	ulong C2;
	...
	C1 += K1;
	C0 += C1 + K0;
	C1 = IntUtils::RotL64(C1, 46) ^ C0;
	C3 += K3;
	C2 += C3 + K2;
	C3 = IntUtils::RotL64(C3, 36) ^ C2;
	C5 += K5 + T0;
	C4 += C5 + K4;
	C5 = IntUtils::RotL64(C5, 19) ^ C4;
	// mix 
	C7 += K7;
	C6 += C7 + K6 + T1;
	C7 = IntUtils::RotL64(C7, 37) ^ C6;
	C2 += C1;
	C1 = IntUtils::RotL64(C1, 33) ^ C2;
	C4 += C7;
	C7 = IntUtils::RotL64(C7, 27) ^ C4;
	C6 += C5;
	C5 = IntUtils::RotL64(C5, 14) ^ C6;
	C0 += C3;
	C3 = IntUtils::RotL64(C3, 42) ^ C0;
	C4 += C1;
	C1 = IntUtils::RotL64(C1, 17) ^ C4;
	C6 += C3;
	C3 = IntUtils::RotL64(C3, 49) ^ C6;
	C0 += C5;
	C5 = IntUtils::RotL64(C5, 36) ^ C0;
	C2 += C7;
	C7 = IntUtils::RotL64(C7, 39) ^ C2;
	C6 += C1;
	C1 = IntUtils::RotL64(C1, 44) ^ C6;
	C0 += C7;
	C7 = IntUtils::RotL64(C7, 9) ^ C0;
	C2 += C5;
	C5 = IntUtils::RotL64(C5, 54) ^ C2;
	C4 += C3;
	C3 = IntUtils::RotL64(C3, 56) ^ C4;
	// inject
	C1 += K2;
	C0 += C1 + K1;
	C1 = IntUtils::RotL64(C1, 39) ^ C0;
	C3 += K4;
	C2 += C3 + K3;
	C3 = IntUtils::RotL64(C3, 30) ^ C2;
	C5 += K6 + T1;
	C4 += C5 + K5;
	C5 = IntUtils::RotL64(C5, 34) ^ C4;
	// mix
	C7 += K8 + 1;
	C6 += C7 + K7 + T2;
	C7 = IntUtils::RotL64(C7, 24) ^ C6;
	C2 += C1;
	C1 = IntUtils::RotL64(C1, 13) ^ C2;
	C4 += C7;
	C7 = IntUtils::RotL64(C7, 50) ^ C4;
	C6 += C5;
	C5 = IntUtils::RotL64(C5, 10) ^ C6;
	C0 += C3;
	C3 = IntUtils::RotL64(C3, 17) ^ C0;
	C4 += C1;
	C1 = IntUtils::RotL64(C1, 25) ^ C4;
	C6 += C3;
	C3 = IntUtils::RotL64(C3, 29) ^ C6;
	C0 += C5;
	C5 = IntUtils::RotL64(C5, 39) ^ C0;
	C2 += C7;
	C7 = IntUtils::RotL64(C7, 43) ^ C2;
	C6 += C1;
	C1 = IntUtils::RotL64(C1, 8) ^ C6;
	C0 += C7;
	C7 = IntUtils::RotL64(C7, 35) ^ C0;
	C2 += C5;
	C5 = IntUtils::RotL64(C5, 56) ^ C2;
	C4 += C3;
	C3 = IntUtils::RotL64(C3, 22) ^ C4;
	// rounds 8-15
	C1 += K3;
	C0 += C1 + K2;
	C1 = IntUtils::RotL64(C1, 46) ^ C0;
...
void Threefish::PemuteP4x512H(const std::array<ulong, 8> &Key, const std::array<ulong, 8> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 32> &State, size_t Rounds)
{
...
void Threefish::PemuteP8x512H(const std::array<ulong, 8> &Key, const std::array<ulong, 16> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 64> &State, size_t Rounds)
{
...
void Threefish::PemuteP1024C(const std::array<ulong, 16> &Key, const std::array<ulong, 2> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 16> &State, size_t Rounds)
{
	...
	MemUtils::Copy(Key, 0, K, 0, 16 * sizeof(ulong));
	...
	for (i = 0; i < r; ++i)
	{
		...
		x != 0 ? x -= 1 : x += 16;
		C[0] += C[1] + K[x];
		C[1] = IntUtils::RotL64(C[1], 24) ^ C[0];
		x < 14 ? x += 3 : x -= 14;
		C[3] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[2] += C[3] + K[x];
		C[3] = IntUtils::RotL64(C[3], 13) ^ C[2];
		x < 14 ? x += 3 : x -= 14;
		C[5] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[4] += C[5] + K[x];
		C[5] = IntUtils::RotL64(C[5], 8) ^ C[4];
		x < 14 ? x += 3 : x -= 14;
		C[7] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[6] += C[7] + K[x];
		C[7] = IntUtils::RotL64(C[7], 47) ^ C[6];
		x < 14 ? x += 3 : x -= 14;
		C[9] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[8] += C[9] + K[x];
		C[9] = IntUtils::RotL64(C[9], 8) ^ C[8];
		x < 14 ? x += 3 : x -= 14;
		C[11] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[10] += C[11] + K[x];
		C[11] = IntUtils::RotL64(C[11], 17) ^ C[10];
		x < 14 ? x += 3 : x -= 14;
		C[13] += K[x] + T[y];
		x != 0 ? x -= 1 : x += 16;
		C[12] += C[13] + K[x];
		C[13] = IntUtils::RotL64(C[13], 22) ^ C[12];
		// mix
		x < 14 ? x += 3 : x -= 14;
		C[15] += K[x] + (i * 2);
		x != 0 ? x -= 1 : x += 16;
		y != 2 ? y += 1 : y -= 2;
		C[14] += C[15] + K[x] + T[y];
		C[15] = IntUtils::RotL64(C[15], 37) ^ C[14];
		C[0] += C[9];
		C[9] = IntUtils::RotL64(C[9], 38) ^ C[0];
		C[2] += C[13];
		C[13] = IntUtils::RotL64(C[13], 19) ^ C[2];
		C[6] += C[11];
		C[11] = IntUtils::RotL64(C[11], 10) ^ C[6];
		C[4] += C[15];
		C[15] = IntUtils::RotL64(C[15], 55) ^ C[4];
		C[10] += C[7];
		C[7] = IntUtils::RotL64(C[7], 49) ^ C[10];
		C[12] += C[3];
		C[3] = IntUtils::RotL64(C[3], 18) ^ C[12];
		C[14] += C[5];
		C[5] = IntUtils::RotL64(C[5], 23) ^ C[14];
		C[8] += C[1];
		C[1] = IntUtils::RotL64(C[1], 52) ^ C[8];
		C[0] += C[7];
		C[7] = IntUtils::RotL64(C[7], 33) ^ C[0];
		C[2] += C[5];
		C[5] = IntUtils::RotL64(C[5], 4) ^ C[2];
		C[4] += C[3];
		C[3] = IntUtils::RotL64(C[3], 51) ^ C[4];
		C[6] += C[1];
		C[1] = IntUtils::RotL64(C[1], 13) ^ C[6];
		C[12] += C[15];
		C[15] = IntUtils::RotL64(C[15], 34) ^ C[12];
		C[14] += C[13];
		C[13] = IntUtils::RotL64(C[13], 41) ^ C[14];
		C[8] += C[11];
		C[11] = IntUtils::RotL64(C[11], 59) ^ C[8];
		C[10] += C[9];
		C[9] = IntUtils::RotL64(C[9], 17) ^ C[10];
		C[0] += C[15];
		C[15] = IntUtils::RotL64(C[15], 5) ^ C[0];
		C[2] += C[11];
		C[11] = IntUtils::RotL64(C[11], 20) ^ C[2];
		C[6] += C[13];
		C[13] = IntUtils::RotL64(C[13], 48) ^ C[6];
		C[4] += C[9];
		C[9] = IntUtils::RotL64(C[9], 41) ^ C[4];
		C[14] += C[1];
		C[1] = IntUtils::RotL64(C[1], 47) ^ C[14];
		C[8] += C[5];
		C[5] = IntUtils::RotL64(C[5], 28) ^ C[8];
		C[10] += C[3];
		C[3] = IntUtils::RotL64(C[3], 16) ^ C[10];
		C[12] += C[7];
		C[7] = IntUtils::RotL64(C[7], 25) ^ C[12];
		// inject
		x > 11 ? x -= 12 : x += 5;
		C[1] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[0] += C[1] + K[x];
		C[1] = IntUtils::RotL64(C[1], 41) ^ C[0];
		x < 14 ? x += 3 : x -= 14;
		C[3] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[2] += C[3] + K[x];
		C[3] = IntUtils::RotL64(C[3], 9) ^ C[2];
		x < 14 ? x += 3 : x -= 14;
		C[5] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[4] += C[5] + K[x];
		C[5] = IntUtils::RotL64(C[5], 37) ^ C[4];
		x < 14 ? x += 3 : x -= 14;
		C[7] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[6] += C[7] + K[x];
		C[7] = IntUtils::RotL64(C[7], 31) ^ C[6];
		x < 14 ? x += 3 : x -= 14;
		C[9] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[8] += C[9] + K[x];
		C[9] = IntUtils::RotL64(C[9], 12) ^ C[8];
		x < 14 ? x += 3 : x -= 14;
		C[11] += K[x];
		x != 0 ? x -= 1 : x += 16;
		C[10] += C[11] + K[x];
		C[11] = IntUtils::RotL64(C[11], 47) ^ C[10];
		x < 14 ? x += 3 : x -= 14;
		C[13] += K[x] + T[y];
		x != 0 ? x -= 1 : x += 16;
		C[12] += C[13] + K[x];
		C[13] = IntUtils::RotL64(C[13], 44) ^ C[12];
		// mix
		x < 14 ? x += 3 : x -= 14;
		C[15] += K[x] + (i * 2) + 1;
		x != 0 ? x -= 1 : x += 16;
		y != 2 ? y += 1 : y -= 2;
		C[14] += C[15] + K[x] + T[y];
		C[15] = IntUtils::RotL64(C[15], 30) ^ C[14];
		C[0] += C[9];
		C[9] = IntUtils::RotL64(C[9], 16) ^ C[0];
		C[2] += C[13];
		C[13] = IntUtils::RotL64(C[13], 34) ^ C[2];
		C[6] += C[11];
		C[11] = IntUtils::RotL64(C[11], 56) ^ C[6];
		C[4] += C[15];
		C[15] = IntUtils::RotL64(C[15], 51) ^ C[4];
		C[10] += C[7];
		C[7] = IntUtils::RotL64(C[7], 4) ^ C[10];
		C[12] += C[3];
		C[3] = IntUtils::RotL64(C[3], 53) ^ C[12];
		C[14] += C[5];
		C[5] = IntUtils::RotL64(C[5], 42) ^ C[14];
		C[8] += C[1];
		C[1] = IntUtils::RotL64(C[1], 41) ^ C[8];
		C[0] += C[7];
		C[7] = IntUtils::RotL64(C[7], 31) ^ C[0];
		C[2] += C[5];
		C[5] = IntUtils::RotL64(C[5], 44) ^ C[2];
		C[4] += C[3];
		C[3] = IntUtils::RotL64(C[3], 47) ^ C[4];
		C[6] += C[1];
		C[1] = IntUtils::RotL64(C[1], 46) ^ C[6];
		C[12] += C[15];
		C[15] = IntUtils::RotL64(C[15], 19) ^ C[12];
		C[14] += C[13];
		C[13] = IntUtils::RotL64(C[13], 42) ^ C[14];
		C[8] += C[11];
		C[11] = IntUtils::RotL64(C[11], 44) ^ C[8];
		C[10] += C[9];
		C[9] = IntUtils::RotL64(C[9], 25) ^ C[10];
		C[0] += C[15];
		C[15] = IntUtils::RotL64(C[15], 9) ^ C[0];
		C[2] += C[11];
		C[11] = IntUtils::RotL64(C[11], 48) ^ C[2];
		C[6] += C[13];
		C[13] = IntUtils::RotL64(C[13], 35) ^ C[6];
		C[4] += C[9];
		C[9] = IntUtils::RotL64(C[9], 52) ^ C[4];
		C[14] += C[1];
		C[1] = IntUtils::RotL64(C[1], 23) ^ C[14];
		C[8] += C[5];
		C[5] = IntUtils::RotL64(C[5], 31) ^ C[8];
		C[10] += C[3];
		C[3] = IntUtils::RotL64(C[3], 37) ^ C[10];
		C[12] += C[7];
		C[7] = IntUtils::RotL64(C[7], 20) ^ C[12];
		x > 11 ? x -= 12 : x += 5;
	}
...
void Threefish::PemuteR120P1024U(const std::array<ulong, 16> &Key, const std::array<ulong, 2> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 16> &State)
{
	ulong C0;
	ulong C1;
	ulong C2;
	...
	C1 += K1;
	C0 += C1 + K0;
	C1 = IntUtils::RotL64(C1, 24) ^ C0;
	C3 += K3;
	C2 += C3 + K2;
	C3 = IntUtils::RotL64(C3, 13) ^ C2;
	C5 += K5;
	C4 += C5 + K4;
	C5 = IntUtils::RotL64(C5, 8) ^ C4;
	C7 += K7;
	C6 += C7 + K6;
	C7 = IntUtils::RotL64(C7, 47) ^ C6;
	C9 += K9;
	C8 += C9 + K8;
	C9 = IntUtils::RotL64(C9, 8) ^ C8;
	C11 += K11;
	C10 += C11 + K10;
	C11 = IntUtils::RotL64(C11, 17) ^ C10;
	C13 += K13 + T0;
	C12 += C13 + K12;
	C13 = IntUtils::RotL64(C13, 22) ^ C12;
	// mix
	C15 += K15;
	C14 += C15 + K14 + T1;
	C15 = IntUtils::RotL64(C15, 37) ^ C14;
	C0 += C9;
	C9 = IntUtils::RotL64(C9, 38) ^ C0;
	C2 += C13;
	C13 = IntUtils::RotL64(C13, 19) ^ C2;
	C6 += C11;
	C11 = IntUtils::RotL64(C11, 10) ^ C6;
	C4 += C15;
	C15 = IntUtils::RotL64(C15, 55) ^ C4;
	C10 += C7;
	C7 = IntUtils::RotL64(C7, 49) ^ C10;
	C12 += C3;
	C3 = IntUtils::RotL64(C3, 18) ^ C12;
	C14 += C5;
	C5 = IntUtils::RotL64(C5, 23) ^ C14;
	C8 += C1;
	C1 = IntUtils::RotL64(C1, 52) ^ C8;
	C0 += C7;
	C7 = IntUtils::RotL64(C7, 33) ^ C0;
	C2 += C5;
	C5 = IntUtils::RotL64(C5, 4) ^ C2;
	C4 += C3;
	C3 = IntUtils::RotL64(C3, 51) ^ C4;
	C6 += C1;
	C1 = IntUtils::RotL64(C1, 13) ^ C6;
	C12 += C15;
	C15 = IntUtils::RotL64(C15, 34) ^ C12;
	C14 += C13;
	C13 = IntUtils::RotL64(C13, 41) ^ C14;
	C8 += C11;
	C11 = IntUtils::RotL64(C11, 59) ^ C8;
	C10 += C9;
	C9 = IntUtils::RotL64(C9, 17) ^ C10;
	C0 += C15;
	C15 = IntUtils::RotL64(C15, 5) ^ C0;
	C2 += C11;
	C11 = IntUtils::RotL64(C11, 20) ^ C2;
	C6 += C13;
	C13 = IntUtils::RotL64(C13, 48) ^ C6;
	C4 += C9;
	C9 = IntUtils::RotL64(C9, 41) ^ C4;
	C14 += C1;
	C1 = IntUtils::RotL64(C1, 47) ^ C14;
	C8 += C5;
	C5 = IntUtils::RotL64(C5, 28) ^ C8;
	C10 += C3;
	C3 = IntUtils::RotL64(C3, 16) ^ C10;
	C12 += C7;
	C7 = IntUtils::RotL64(C7, 25) ^ C12;
	// inject 
	C1 += K2;
	C0 += C1 + K1;
	C1 = IntUtils::RotL64(C1, 41) ^ C0;
	C3 += K4;
	C2 += C3 + K3;
	C3 = IntUtils::RotL64(C3, 9) ^ C2;
	C5 += K6;
	C4 += C5 + K5;
	C5 = IntUtils::RotL64(C5, 37) ^ C4;
	C7 += K8;
	C6 += C7 + K7;
	C7 = IntUtils::RotL64(C7, 31) ^ C6;
	C9 += K10;
	C8 += C9 + K9;
	C9 = IntUtils::RotL64(C9, 12) ^ C8;
	C11 += K12;
	C10 += C11 + K11;
	C11 = IntUtils::RotL64(C11, 47) ^ C10;
	C13 += K14 + T1;
	C12 += C13 + K13;
	C13 = IntUtils::RotL64(C13, 44) ^ C12;
	// mix
	C15 += K16 + 1;
	C14 += C15 + K15 + T2;
	C15 = IntUtils::RotL64(C15, 30) ^ C14;
	C0 += C9;
	C9 = IntUtils::RotL64(C9, 16) ^ C0;
	C2 += C13;
	C13 = IntUtils::RotL64(C13, 34) ^ C2;
	C6 += C11;
	C11 = IntUtils::RotL64(C11, 56) ^ C6;
	C4 += C15;
	C15 = IntUtils::RotL64(C15, 51) ^ C4;
	C10 += C7;
	C7 = IntUtils::RotL64(C7, 4) ^ C10;
	C12 += C3;
	C3 = IntUtils::RotL64(C3, 53) ^ C12;
	C14 += C5;
	C5 = IntUtils::RotL64(C5, 42) ^ C14;
	C8 += C1;
	C1 = IntUtils::RotL64(C1, 41) ^ C8;
	C0 += C7;
	C7 = IntUtils::RotL64(C7, 31) ^ C0;
	C2 += C5;
	C5 = IntUtils::RotL64(C5, 44) ^ C2;
	C4 += C3;
	C3 = IntUtils::RotL64(C3, 47) ^ C4;
	C6 += C1;
	C1 = IntUtils::RotL64(C1, 46) ^ C6;
	C12 += C15;
	C15 = IntUtils::RotL64(C15, 19) ^ C12;
	C14 += C13;
	C13 = IntUtils::RotL64(C13, 42) ^ C14;
	C8 += C11;
	C11 = IntUtils::RotL64(C11, 44) ^ C8;
	C10 += C9;
	C9 = IntUtils::RotL64(C9, 25) ^ C10;
	C0 += C15;
	C15 = IntUtils::RotL64(C15, 9) ^ C0;
	C2 += C11;
	C11 = IntUtils::RotL64(C11, 48) ^ C2;
	C6 += C13;
	C13 = IntUtils::RotL64(C13, 35) ^ C6;
	C4 += C9;
	C9 = IntUtils::RotL64(C9, 52) ^ C4;
	C14 += C1;
	C1 = IntUtils::RotL64(C1, 23) ^ C14;
	C8 += C5;
	C5 = IntUtils::RotL64(C5, 31) ^ C8;
	C10 += C3;
	C3 = IntUtils::RotL64(C3, 37) ^ C10;
	C12 += C7;
	C7 = IntUtils::RotL64(C7, 20) ^ C12;
	// rounds 8-15
	C1 += K3;
	C0 += C1 + K2;
	C1 = IntUtils::RotL64(C1, 24) ^ C0;
...
void Threefish::PemuteP4x1024H(const std::array<ulong, 16> &Key, const std::array<ulong, 8> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 64> &State, size_t Rounds)
{
...
void Threefish::PemuteP8x1024H(const std::array<ulong, 16> &Key, const std::array<ulong, 16> &Counter, const std::array<ulong, 2> &Tweak, std::array<ulong, 128> &State, size_t Rounds)
{
