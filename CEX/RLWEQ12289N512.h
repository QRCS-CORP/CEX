...
#ifndef CEX_RLWEQ12289N512_H
#define CEX_RLWEQ12289N512_H
...
public:
	...
	/// </summary>
	static const size_t RLWE_PUBPOLY_SIZE = 896;
	...
	/// </summary>
	static const size_t RLWE_CIPHERTEXT_SIZE = RLWE_PUBPOLY_SIZE + RLWE_RECEIVED_SIZE;
...
#	endif 
	...
	static void FromBytes(std::array<ushort, RLWE_N> &R, const std::vector<byte> &A);
