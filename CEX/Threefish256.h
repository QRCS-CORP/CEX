...
/// The supported MAC generator options for Threefish256 are HMAC(SHA2-256), and the Keccak based KMAC-256.</para>
///
...
/// <item><description>Block size is 32 bytes wide (256 bits).</description></item>
/// <item><description>Permutation rounds are fixed at 72.</description></item>
...
private:
	...
	struct Threefish256State;

	StreamAuthenticators m_authenticatorType;
	std::unique_ptr<Threefish256State> m_cipherState;
