...
public:
	...
	inline static void Compress64(const std::vector<byte> &Input, size_t InOffset, State &Output)
	{
		...
		Round256(A, B, C, D, E, F, G, H, W0, 0x428A2F98);
		W1 = IntUtils::BeBytesTo32(Input, InOffset + 4);
		Round256(H, A, B, C, D, E, F, G, W1, 0x71374491);
		W2 = IntUtils::BeBytesTo32(Input, InOffset + 8);
		Round256(G, H, A, B, C, D, E, F, W2, 0xB5C0FBCF);
		W3 = IntUtils::BeBytesTo32(Input, InOffset + 12);
		Round256(F, G, H, A, B, C, D, E, W3, 0xE9B5DBA5);
		W4 = IntUtils::BeBytesTo32(Input, InOffset + 16);
		Round256(E, F, G, H, A, B, C, D, W4, 0x3956C25B);
		W5 = IntUtils::BeBytesTo32(Input, InOffset + 20);
		Round256(D, E, F, G, H, A, B, C, W5, 0x59F111F1);
		W6 = IntUtils::BeBytesTo32(Input, InOffset + 24);
		Round256(C, D, E, F, G, H, A, B, W6, 0x923F82A4);
		W7 = IntUtils::BeBytesTo32(Input, InOffset + 28);
		Round256(B, C, D, E, F, G, H, A, W7, 0xAB1C5ED5);
		W8 = IntUtils::BeBytesTo32(Input, InOffset + 32);
		Round256(A, B, C, D, E, F, G, H, W8, 0xD807AA98);
		W9 = IntUtils::BeBytesTo32(Input, InOffset + 36);
		Round256(H, A, B, C, D, E, F, G, W9, 0x12835B01);
		W10 = IntUtils::BeBytesTo32(Input, InOffset + 40);
		Round256(G, H, A, B, C, D, E, F, W10, 0x243185BE);
		W11 = IntUtils::BeBytesTo32(Input, InOffset + 44);
		Round256(F, G, H, A, B, C, D, E, W11, 0x550C7DC3);
		W12 = IntUtils::BeBytesTo32(Input, InOffset + 48);
		Round256(E, F, G, H, A, B, C, D, W12, 0x72BE5D74);
		W13 = IntUtils::BeBytesTo32(Input, InOffset + 52);
		Round256(D, E, F, G, H, A, B, C, W13, 0x80DEB1FE);
		W14 = IntUtils::BeBytesTo32(Input, InOffset + 56);
		Round256(C, D, E, F, G, H, A, B, W14, 0x9BDC06A7);
		W15 = IntUtils::BeBytesTo32(Input, InOffset + 60);
		Round256(B, C, D, E, F, G, H, A, W15, 0xC19BF174);

		W0 += UlSigma1(W14) + W9 + UlSigma0(W1);
		Round256(A, B, C, D, E, F, G, H, W0, 0xE49B69C1);
		W1 += UlSigma1(W15) + W10 + UlSigma0(W2);
		Round256(H, A, B, C, D, E, F, G, W1, 0xEFBE4786);
		W2 += UlSigma1(W0) + W11 + UlSigma0(W3);
		Round256(G, H, A, B, C, D, E, F, W2, 0x0FC19DC6);
		W3 += UlSigma1(W1) + W12 + UlSigma0(W4);
		Round256(F, G, H, A, B, C, D, E, W3, 0x240CA1CC);
		W4 += UlSigma1(W2) + W13 + UlSigma0(W5);
		Round256(E, F, G, H, A, B, C, D, W4, 0x2DE92C6F);
		W5 += UlSigma1(W3) + W14 + UlSigma0(W6);
		Round256(D, E, F, G, H, A, B, C, W5, 0x4A7484AA);
		W6 += UlSigma1(W4) + W15 + UlSigma0(W7);
		Round256(C, D, E, F, G, H, A, B, W6, 0x5CB0A9DC);
		W7 += UlSigma1(W5) + W0 + UlSigma0(W8);
		Round256(B, C, D, E, F, G, H, A, W7, 0x76F988DA);
		W8 += UlSigma1(W6) + W1 + UlSigma0(W9);
		Round256(A, B, C, D, E, F, G, H, W8, 0x983E5152);
		W9 += UlSigma1(W7) + W2 + UlSigma0(W10);
		Round256(H, A, B, C, D, E, F, G, W9, 0xA831C66D);
		W10 += UlSigma1(W8) + W3 + UlSigma0(W11);
		Round256(G, H, A, B, C, D, E, F, W10, 0xB00327C8);
		W11 += UlSigma1(W9) + W4 + UlSigma0(W12);
		Round256(F, G, H, A, B, C, D, E, W11, 0xBF597FC7);
		W12 += UlSigma1(W10) + W5 + UlSigma0(W13);
		Round256(E, F, G, H, A, B, C, D, W12, 0xC6E00BF3);
		W13 += UlSigma1(W11) + W6 + UlSigma0(W14);
		Round256(D, E, F, G, H, A, B, C, W13, 0xD5A79147);
		W14 += UlSigma1(W12) + W7 + UlSigma0(W15);
		Round256(C, D, E, F, G, H, A, B, W14, 0x06CA6351);
		W15 += UlSigma1(W13) + W8 + UlSigma0(W0);
		Round256(B, C, D, E, F, G, H, A, W15, 0x14292967);

		W0 += UlSigma1(W14) + W9 + UlSigma0(W1);
		Round256(A, B, C, D, E, F, G, H, W0, 0x27B70A85);
		W1 += UlSigma1(W15) + W10 + UlSigma0(W2);
		Round256(H, A, B, C, D, E, F, G, W1, 0x2E1B2138);
		W2 += UlSigma1(W0) + W11 + UlSigma0(W3);
		Round256(G, H, A, B, C, D, E, F, W2, 0x4D2C6DFC);
		W3 += UlSigma1(W1) + W12 + UlSigma0(W4);
		Round256(F, G, H, A, B, C, D, E, W3, 0x53380D13);
		W4 += UlSigma1(W2) + W13 + UlSigma0(W5);
		Round256(E, F, G, H, A, B, C, D, W4, 0x650A7354);
		W5 += UlSigma1(W3) + W14 + UlSigma0(W6);
		Round256(D, E, F, G, H, A, B, C, W5, 0x766A0ABB);
		W6 += UlSigma1(W4) + W15 + UlSigma0(W7);
		Round256(C, D, E, F, G, H, A, B, W6, 0x81C2C92E);
		W7 += UlSigma1(W5) + W0 + UlSigma0(W8);
		Round256(B, C, D, E, F, G, H, A, W7, 0x92722C85);
		W8 += UlSigma1(W6) + W1 + UlSigma0(W9);
		Round256(A, B, C, D, E, F, G, H, W8, 0xA2BFE8A1);
		W9 += UlSigma1(W7) + W2 + UlSigma0(W10);
		Round256(H, A, B, C, D, E, F, G, W9, 0xA81A664B);
		W10 += UlSigma1(W8) + W3 + UlSigma0(W11);
		Round256(G, H, A, B, C, D, E, F, W10, 0xC24B8B70);
		W11 += UlSigma1(W9) + W4 + UlSigma0(W12);
		Round256(F, G, H, A, B, C, D, E, W11, 0xC76C51A3);
		W12 += UlSigma1(W10) + W5 + UlSigma0(W13);
		Round256(E, F, G, H, A, B, C, D, W12, 0xD192E819);
		W13 += UlSigma1(W11) + W6 + UlSigma0(W14);
		Round256(D, E, F, G, H, A, B, C, W13, 0xD6990624);
		W14 += UlSigma1(W12) + W7 + UlSigma0(W15);
		Round256(C, D, E, F, G, H, A, B, W14, 0xF40E3585);
		W15 += UlSigma1(W13) + W8 + UlSigma0(W0);
		Round256(B, C, D, E, F, G, H, A, W15, 0x106AA070);

		W0 += UlSigma1(W14) + W9 + UlSigma0(W1);
		Round256(A, B, C, D, E, F, G, H, W0, 0x19A4C116);
		W1 += UlSigma1(W15) + W10 + UlSigma0(W2);
		Round256(H, A, B, C, D, E, F, G, W1, 0x1E376C08);
		W2 += UlSigma1(W0) + W11 + UlSigma0(W3);
		Round256(G, H, A, B, C, D, E, F, W2, 0x2748774C);
		W3 += UlSigma1(W1) + W12 + UlSigma0(W4);
		Round256(F, G, H, A, B, C, D, E, W3, 0x34B0BCB5);
		W4 += UlSigma1(W2) + W13 + UlSigma0(W5);
		Round256(E, F, G, H, A, B, C, D, W4, 0x391C0CB3);
		W5 += UlSigma1(W3) + W14 + UlSigma0(W6);
		Round256(D, E, F, G, H, A, B, C, W5, 0x4ED8AA4A);
		W6 += UlSigma1(W4) + W15 + UlSigma0(W7);
		Round256(C, D, E, F, G, H, A, B, W6, 0x5B9CCA4F);
		W7 += UlSigma1(W5) + W0 + UlSigma0(W8);
		Round256(B, C, D, E, F, G, H, A, W7, 0x682E6FF3);
		W8 += UlSigma1(W6) + W1 + UlSigma0(W9);
		Round256(A, B, C, D, E, F, G, H, W8, 0x748F82EE);
		W9 += UlSigma1(W7) + W2 + UlSigma0(W10);
		Round256(H, A, B, C, D, E, F, G, W9, 0x78A5636F);
		W10 += UlSigma1(W8) + W3 + UlSigma0(W11);
		Round256(G, H, A, B, C, D, E, F, W10, 0x84C87814);
		W11 += UlSigma1(W9) + W4 + UlSigma0(W12);
		Round256(F, G, H, A, B, C, D, E, W11, 0x8CC70208);
		W12 += UlSigma1(W10) + W5 + UlSigma0(W13);
		Round256(E, F, G, H, A, B, C, D, W12, 0x90BEFFFA);
		W13 += UlSigma1(W11) + W6 + UlSigma0(W14);
		Round256(D, E, F, G, H, A, B, C, W13, 0xA4506CEB);
		W14 += UlSigma1(W12) + W7 + UlSigma0(W15);
		Round256(C, D, E, F, G, H, A, B, W14, 0xBEF9A3F7);
		W15 += UlSigma1(W13) + W8 + UlSigma0(W0);
		Round256(B, C, D, E, F, G, H, A, W15, 0xC67178F2);
	...
	inline static void Compress128(const std::vector<byte> &Input, size_t InOffset, State &Output)
	{
		...
		Round512(A, B, C, D, E, F, G, H, W0, 0x428A2F98D728AE22);
		W1 = IntUtils::BeBytesTo64(Input, InOffset + 8);
		Round512(H, A, B, C, D, E, F, G, W1, 0x7137449123EF65CD);
		W2 = IntUtils::BeBytesTo64(Input, InOffset + 16);
		Round512(G, H, A, B, C, D, E, F, W2, 0xB5C0FBCFEC4D3B2F);
		W3 = IntUtils::BeBytesTo64(Input, InOffset + 24);
		Round512(F, G, H, A, B, C, D, E, W3, 0xE9B5DBA58189DBBC);
		W4 = IntUtils::BeBytesTo64(Input, InOffset + 32);
		Round512(E, F, G, H, A, B, C, D, W4, 0x3956C25BF348B538);
		W5 = IntUtils::BeBytesTo64(Input, InOffset + 40);
		Round512(D, E, F, G, H, A, B, C, W5, 0x59F111F1B605D019);
		W6 = IntUtils::BeBytesTo64(Input, InOffset + 48);
		Round512(C, D, E, F, G, H, A, B, W6, 0x923F82A4AF194F9B);
		W7 = IntUtils::BeBytesTo64(Input, InOffset + 56);
		Round512(B, C, D, E, F, G, H, A, W7, 0xAB1C5ED5DA6D8118);
		W8 = IntUtils::BeBytesTo64(Input, InOffset + 64);
		Round512(A, B, C, D, E, F, G, H, W8, 0xD807AA98A3030242);
		W9 = IntUtils::BeBytesTo64(Input, InOffset + 72);
		Round512(H, A, B, C, D, E, F, G, W9, 0x12835B0145706FBE);
		W10 = IntUtils::BeBytesTo64(Input, InOffset + 80);
		Round512(G, H, A, B, C, D, E, F, W10, 0x243185BE4EE4B28C);
		W11 = IntUtils::BeBytesTo64(Input, InOffset + 88);
		Round512(F, G, H, A, B, C, D, E, W11, 0x550C7DC3D5FFB4E2);
		W12 = IntUtils::BeBytesTo64(Input, InOffset + 96);
		Round512(E, F, G, H, A, B, C, D, W12, 0x72BE5D74F27B896F);
		W13 = IntUtils::BeBytesTo64(Input, InOffset + 104);
		Round512(D, E, F, G, H, A, B, C, W13, 0x80DEB1FE3B1696B1);
		W14 = IntUtils::BeBytesTo64(Input, InOffset + 112);
		Round512(C, D, E, F, G, H, A, B, W14, 0x9BDC06A725C71235);
		W15 = IntUtils::BeBytesTo64(Input, InOffset + 120);
		Round512(B, C, D, E, F, G, H, A, W15, 0xC19BF174CF692694);

		W0 += UllSigma1(W14) + W9 + UllSigma0(W1);
		Round512(A, B, C, D, E, F, G, H, W0, 0xE49B69C19EF14AD2);
		W1 += UllSigma1(W15) + W10 + UllSigma0(W2);
		Round512(H, A, B, C, D, E, F, G, W1, 0xEFBE4786384F25E3);
		W2 += UllSigma1(W0) + W11 + UllSigma0(W3);
		Round512(G, H, A, B, C, D, E, F, W2, 0x0FC19DC68B8CD5B5);
		W3 += UllSigma1(W1) + W12 + UllSigma0(W4);
		Round512(F, G, H, A, B, C, D, E, W3, 0x240CA1CC77AC9C65);
		W4 += UllSigma1(W2) + W13 + UllSigma0(W5);
		Round512(E, F, G, H, A, B, C, D, W4, 0x2DE92C6F592B0275);
		W5 += UllSigma1(W3) + W14 + UllSigma0(W6);
		Round512(D, E, F, G, H, A, B, C, W5, 0x4A7484AA6EA6E483);
		W6 += UllSigma1(W4) + W15 + UllSigma0(W7);
		Round512(C, D, E, F, G, H, A, B, W6, 0x5CB0A9DCBD41FBD4);
		W7 += UllSigma1(W5) + W0 + UllSigma0(W8);
		Round512(B, C, D, E, F, G, H, A, W7, 0x76F988DA831153B5);
		W8 += UllSigma1(W6) + W1 + UllSigma0(W9);
		Round512(A, B, C, D, E, F, G, H, W8, 0x983E5152EE66DFAB);
		W9 += UllSigma1(W7) + W2 + UllSigma0(W10);
		Round512(H, A, B, C, D, E, F, G, W9, 0xA831C66D2DB43210);
		W10 += UllSigma1(W8) + W3 + UllSigma0(W11);
		Round512(G, H, A, B, C, D, E, F, W10, 0xB00327C898FB213F);
		W11 += UllSigma1(W9) + W4 + UllSigma0(W12);
		Round512(F, G, H, A, B, C, D, E, W11, 0xBF597FC7BEEF0EE4);
		W12 += UllSigma1(W10) + W5 + UllSigma0(W13);
		Round512(E, F, G, H, A, B, C, D, W12, 0xC6E00BF33DA88FC2);
		W13 += UllSigma1(W11) + W6 + UllSigma0(W14);
		Round512(D, E, F, G, H, A, B, C, W13, 0xD5A79147930AA725);
		W14 += UllSigma1(W12) + W7 + UllSigma0(W15);
		Round512(C, D, E, F, G, H, A, B, W14, 0x06CA6351E003826F);
		W15 += UllSigma1(W13) + W8 + UllSigma0(W0);
		Round512(B, C, D, E, F, G, H, A, W15, 0x142929670A0E6E70);

		W0 += UllSigma1(W14) + W9 + UllSigma0(W1);
		Round512(A, B, C, D, E, F, G, H, W0, 0x27B70A8546D22FFC);
		W1 += UllSigma1(W15) + W10 + UllSigma0(W2);
		Round512(H, A, B, C, D, E, F, G, W1, 0x2E1B21385C26C926);
		W2 += UllSigma1(W0) + W11 + UllSigma0(W3);
		Round512(G, H, A, B, C, D, E, F, W2, 0x4D2C6DFC5AC42AED);
		W3 += UllSigma1(W1) + W12 + UllSigma0(W4);
		Round512(F, G, H, A, B, C, D, E, W3, 0x53380D139D95B3DF);
		W4 += UllSigma1(W2) + W13 + UllSigma0(W5);
		Round512(E, F, G, H, A, B, C, D, W4, 0x650A73548BAF63DE);
		W5 += UllSigma1(W3) + W14 + UllSigma0(W6);
		Round512(D, E, F, G, H, A, B, C, W5, 0x766A0ABB3C77B2A8);
		W6 += UllSigma1(W4) + W15 + UllSigma0(W7);
		Round512(C, D, E, F, G, H, A, B, W6, 0x81C2C92E47EDAEE6);
		W7 += UllSigma1(W5) + W0 + UllSigma0(W8);
		Round512(B, C, D, E, F, G, H, A, W7, 0x92722C851482353B);
		W8 += UllSigma1(W6) + W1 + UllSigma0(W9);
		Round512(A, B, C, D, E, F, G, H, W8, 0xA2BFE8A14CF10364);
		W9 += UllSigma1(W7) + W2 + UllSigma0(W10);
		Round512(H, A, B, C, D, E, F, G, W9, 0xA81A664BBC423001);
		W10 += UllSigma1(W8) + W3 + UllSigma0(W11);
		Round512(G, H, A, B, C, D, E, F, W10, 0xC24B8B70D0F89791);
		W11 += UllSigma1(W9) + W4 + UllSigma0(W12);
		Round512(F, G, H, A, B, C, D, E, W11, 0xC76C51A30654BE30);
		W12 += UllSigma1(W10) + W5 + UllSigma0(W13);
		Round512(E, F, G, H, A, B, C, D, W12, 0xD192E819D6EF5218);
		W13 += UllSigma1(W11) + W6 + UllSigma0(W14);
		Round512(D, E, F, G, H, A, B, C, W13, 0xD69906245565A910);
		W14 += UllSigma1(W12) + W7 + UllSigma0(W15);
		Round512(C, D, E, F, G, H, A, B, W14, 0xF40E35855771202A);
		W15 += UllSigma1(W13) + W8 + UllSigma0(W0);
		Round512(B, C, D, E, F, G, H, A, W15, 0x106AA07032BBD1B8);

		W0 += UllSigma1(W14) + W9 + UllSigma0(W1);
		Round512(A, B, C, D, E, F, G, H, W0, 0x19A4C116B8D2D0C8);
		W1 += UllSigma1(W15) + W10 + UllSigma0(W2);
		Round512(H, A, B, C, D, E, F, G, W1, 0x1E376C085141AB53);
		W2 += UllSigma1(W0) + W11 + UllSigma0(W3);
		Round512(G, H, A, B, C, D, E, F, W2, 0x2748774CDF8EEB99);
		W3 += UllSigma1(W1) + W12 + UllSigma0(W4);
		Round512(F, G, H, A, B, C, D, E, W3, 0x34B0BCB5E19B48A8);
		W4 += UllSigma1(W2) + W13 + UllSigma0(W5);
		Round512(E, F, G, H, A, B, C, D, W4, 0x391C0CB3C5C95A63);
		W5 += UllSigma1(W3) + W14 + UllSigma0(W6);
		Round512(D, E, F, G, H, A, B, C, W5, 0x4ED8AA4AE3418ACB);
		W6 += UllSigma1(W4) + W15 + UllSigma0(W7);
		Round512(C, D, E, F, G, H, A, B, W6, 0x5B9CCA4F7763E373);
		W7 += UllSigma1(W5) + W0 + UllSigma0(W8);
		Round512(B, C, D, E, F, G, H, A, W7, 0x682E6FF3D6B2B8A3);
		W8 += UllSigma1(W6) + W1 + UllSigma0(W9);
		Round512(A, B, C, D, E, F, G, H, W8, 0x748F82EE5DEFB2FC);
		W9 += UllSigma1(W7) + W2 + UllSigma0(W10);
		Round512(H, A, B, C, D, E, F, G, W9, 0x78A5636F43172F60);
		W10 += UllSigma1(W8) + W3 + UllSigma0(W11);
		Round512(G, H, A, B, C, D, E, F, W10, 0x84C87814A1F0AB72);
		W11 += UllSigma1(W9) + W4 + UllSigma0(W12);
		Round512(F, G, H, A, B, C, D, E, W11, 0x8CC702081A6439EC);
		W12 += UllSigma1(W10) + W5 + UllSigma0(W13);
		Round512(E, F, G, H, A, B, C, D, W12, 0x90BEFFFA23631E28);
		W13 += UllSigma1(W11) + W6 + UllSigma0(W14);
		Round512(D, E, F, G, H, A, B, C, W13, 0xA4506CEBDE82BDE9);
		W14 += UllSigma1(W12) + W7 + UllSigma0(W15);
		Round512(C, D, E, F, G, H, A, B, W14, 0xBEF9A3F7B2C67915);
		W15 += UllSigma1(W13) + W8 + UllSigma0(W0);
		Round512(B, C, D, E, F, G, H, A, W15, 0xC67178F2E372532B);

		W0 += UllSigma1(W14) + W9 + UllSigma0(W1);
		Round512(A, B, C, D, E, F, G, H, W0, 0xCA273ECEEA26619C);
		W1 += UllSigma1(W15) + W10 + UllSigma0(W2);
		Round512(H, A, B, C, D, E, F, G, W1, 0xD186B8C721C0C207);
		W2 += UllSigma1(W0) + W11 + UllSigma0(W3);
		Round512(G, H, A, B, C, D, E, F, W2, 0xEADA7DD6CDE0EB1E);
		W3 += UllSigma1(W1) + W12 + UllSigma0(W4);
		Round512(F, G, H, A, B, C, D, E, W3, 0xF57D4F7FEE6ED178);
		W4 += UllSigma1(W2) + W13 + UllSigma0(W5);
		Round512(E, F, G, H, A, B, C, D, W4, 0x06F067AA72176FBA);
		W5 += UllSigma1(W3) + W14 + UllSigma0(W6);
		Round512(D, E, F, G, H, A, B, C, W5, 0x0A637DC5A2C898A6);
		W6 += UllSigma1(W4) + W15 + UllSigma0(W7);
		Round512(C, D, E, F, G, H, A, B, W6, 0x113F9804BEF90DAE);
		W7 += UllSigma1(W5) + W0 + UllSigma0(W8);
		Round512(B, C, D, E, F, G, H, A, W7, 0x1B710B35131C471B);
		W8 += UllSigma1(W6) + W1 + UllSigma0(W9);
		Round512(A, B, C, D, E, F, G, H, W8, 0x28DB77F523047D84);
		W9 += UllSigma1(W7) + W2 + UllSigma0(W10);
		Round512(H, A, B, C, D, E, F, G, W9, 0x32CAAB7B40C72493);
		W10 += UllSigma1(W8) + W3 + UllSigma0(W11);
		Round512(G, H, A, B, C, D, E, F, W10, 0x3C9EBE0A15C9BEBC);
		W11 += UllSigma1(W9) + W4 + UllSigma0(W12);
		Round512(F, G, H, A, B, C, D, E, W11, 0x431D67C49C100D4C);
		W12 += UllSigma1(W10) + W5 + UllSigma0(W13);
		Round512(E, F, G, H, A, B, C, D, W12, 0x4CC5D4BECB3E42B6);
		W13 += UllSigma1(W11) + W6 + UllSigma0(W14);
		Round512(D, E, F, G, H, A, B, C, W13, 0x597F299CFC657E2A);
		W14 += UllSigma1(W12) + W7 + UllSigma0(W15);
		Round512(C, D, E, F, G, H, A, B, W14, 0x5FCB6FAB3AD6FAEC);
		W15 += UllSigma1(W13) + W8 + UllSigma0(W0);
		Round512(B, C, D, E, F, G, H, A, W15, 0x6C44198C4A475817);
