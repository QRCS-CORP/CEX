...
/// <summary>
/// A MAC key and vector container class (MacParams)
/// </summary>
class MacParams
{
private:
...
public:
	...
	/// <summary>
	/// Get: The primary MAC key
	/// </summary>
	const std::vector<byte> &Key() const { return _key; }

	/// <summary>
	/// Set: The primary MAC key
	/// </summary>
	std::vector<byte> &Key() { return _key; }

	/// <summary>
	/// Get: The salt value, added as an additional source of entropy
	/// </summary>
	const std::vector<byte> &Salt() const { return _salt; }

	/// <summary>
	/// Set: The salt value, added as an additional source of entropy
	/// </summary>
	...
	/// <summary>
	/// Set: The personalization info, added as entropy or a distribution code
	/// </summary>
	...
	/// <summary>
	/// Instantiate this class with a MAC Key
	/// </summary>
	///
	...
	/// <summary>
	/// Instantiate this class with a MAC Key, and Salt
	/// </summary>
	///
	/// <param name="Key">MAC Key</param>
	...
	/// <summary>
	/// Instantiate this class with a Cipher Key, Salt, and Info
	/// </summary>
	///
	/// <param name="Key">MAC Key</param>
	/// <param name="Salt">MAC Salt</param>
	...
	void Destroy()
	{
		...
		{
			if (_key.capacity() > 0)
				Utility::ArrayUtils::ClearVector(_key);
			if (_salt.capacity() > 0)
				Utility::ArrayUtils::ClearVector(_salt);
			if (_info.capacity() > 0)
	...
	static MacParams* DeSerialize(IO::MemoryStream &KeyStream)
	{
	...
	static IO::MemoryStream* Serialize(MacParams &KeyObj)
	{
