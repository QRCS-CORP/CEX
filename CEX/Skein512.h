...
/// The default settings are applied when using the Skein512(bool) constructor, or a manually defined configuration when using the Skein512(SkeinParams) constructor.<BR></BR>
/// The SkeinParams structure contains property accessors that are initialized by the boolean constructor at their defaults; 
/// Schema(83,72,65,51) OuputSize(64), Version(1), FanOut(Parallel ? 8 : 0), and LeafSize(64).<BR></BR>
