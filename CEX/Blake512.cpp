...
void Blake512::Destroy()
{
	if (!m_isDestroyed)
	{
		...
		IntUtils::ClearVector(m_hashVal);
		IntUtils::ClearVector(m_salt64);
		IntUtils::ClearVector(m_M);
		IntUtils::ClearVector(m_V);
	}
}
...
size_t Blake512::DoFinal(std::vector<byte> &Output, const size_t OutOffset)
{
	...
	IntUtils::Be64ToBytes(m_T + ((ulong)m_dataLen << 3), msgLen, 8);
	...
	IntUtils::Be64ToBytes(m_hashVal[0], digest, 0);
	IntUtils::Be64ToBytes(m_hashVal[1], digest, 8);
	IntUtils::Be64ToBytes(m_hashVal[2], digest, 16);
	IntUtils::Be64ToBytes(m_hashVal[3], digest, 24);
	IntUtils::Be64ToBytes(m_hashVal[4], digest, 32);
	IntUtils::Be64ToBytes(m_hashVal[5], digest, 40);
	IntUtils::Be64ToBytes(m_hashVal[6], digest, 48);
	IntUtils::Be64ToBytes(m_hashVal[7], digest, 56);
...
{
	m_M[0] = IntUtils::BytesToBe64(Block, Offset);
	m_M[1] = IntUtils::BytesToBe64(Block, Offset + 8);
	m_M[2] = IntUtils::BytesToBe64(Block, Offset + 16);
	m_M[3] = IntUtils::BytesToBe64(Block, Offset + 24);
	m_M[4] = IntUtils::BytesToBe64(Block, Offset + 32);
	m_M[5] = IntUtils::BytesToBe64(Block, Offset + 40);
	m_M[6] = IntUtils::BytesToBe64(Block, Offset + 48);
	m_M[7] = IntUtils::BytesToBe64(Block, Offset + 56);
	m_M[8] = IntUtils::BytesToBe64(Block, Offset + 64);
	m_M[9] = IntUtils::BytesToBe64(Block, Offset + 72);
	m_M[10] = IntUtils::BytesToBe64(Block, Offset + 80);
	m_M[11] = IntUtils::BytesToBe64(Block, Offset + 88);
	m_M[12] = IntUtils::BytesToBe64(Block, Offset + 96);
	m_M[13] = IntUtils::BytesToBe64(Block, Offset + 104);
	m_M[14] = IntUtils::BytesToBe64(Block, Offset + 112);
	m_M[15] = IntUtils::BytesToBe64(Block, Offset + 120);
...
void Blake512::Mix(size_t A, size_t B, size_t C, size_t D, size_t R, size_t I)
{
	...
	m_V[D] = IntUtils::RotFR64(m_V[D] ^ m_V[A], 32);
	m_V[C] += m_V[D];
	m_V[B] = IntUtils::RotFR64(m_V[B] ^ m_V[C], 25);
	m_V[A] += m_V[B] + (m_M[P1] ^ m_C64[P0]);
	m_V[D] = IntUtils::RotFR64(m_V[D] ^ m_V[A], 16);
	m_V[C] += m_V[D];
	m_V[B] = IntUtils::RotFR64(m_V[B] ^ m_V[C], 11);
}
