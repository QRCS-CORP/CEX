...
private:
	...
	static const uint DILITHIUM_K = 4;
	static const uint DILITHIUM_L = 3;
	static const uint DILITHIUM_ETA = 6;
	static const uint DILITHIUM_SETABITS = 4;
	static const uint DILITHIUM_BETA = 325;
	static const uint DILITHIUM_OMEGA = 80;
