...
/// </summary>
class CryptoProcessingException : public CryptoException
{
public:
	...
	CryptoProcessingException(const std::string &Location, const std::string &Origin, const std::string &Message, ErrorCodes ErrorCode);
