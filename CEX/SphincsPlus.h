...
/// <summary>
/// An implementation of the SphincsPlus asymmetric signature scheme (SPHINCS+)
/// </summary> 
/// 
/// <example>
...
/// </list>
/// </remarks>
class SphincsPlus final : public IAsymmetricSigner
{
private:
...
public:
	...
	/// 
	/// <exception cref="CryptoAsymmetricException">Thrown if an invalid prng, or parameter set is specified</exception>
	SphincsPlus(SphincsPlusParameters Parameters, IPrng* Rng);

	/// <summary>
	/// Finalizer: destroys the containers objects
	/// </summary>
	virtual ~SphincsPlus() noexcept;
