...
bool NTRUSQ4591P761::Decapsulate(std::vector<byte> &Secret, const std::vector<byte> &CipherText, const std::vector<byte> &PrivateKey)
{
	// k = Decap(c,sk)
...
void NTRUSQ4591P761::Encapsulate(std::vector<byte> &Secret, std::vector<byte> &CipherText, const std::vector<byte> &PublicKey, std::unique_ptr<Prng::IPrng> &Rng)
{
	// c,k = Encap(pk)
...
void NTRUSQ4591P761::Generate(std::vector<byte> &PublicKey, std::vector<byte> &PrivateKey, std::unique_ptr<Prng::IPrng> &Rng)
{
...
void NTRUSQ4591P761::Hash(std::vector<byte> &Output, size_t OutOffset, int B, const std::vector<byte> &Input)
{
...
void NTRUSQ4591P761::HashSession(std::vector<byte> &K, int B, const std::vector<byte> &Y, const std::vector<byte> &Z)
{
	// k = HashSession(b,y,z)
...
void NTRUSQ4591P761::Hide(std::vector<byte> &C, std::vector<byte> &REnc, const std::vector<int8_t> &R, const std::vector<byte> &Pk, const std::vector<byte> &Cache)
{
...
void NTRUSQ4591P761::ShortFromList(std::vector<int8_t> &Output, const std::vector<uint> &Input)
{
...
void NTRUSQ4591P761::ShortRandom(std::vector<int8_t> &Output, std::unique_ptr<Prng::IPrng> &Rng)
{
...
void NTRUSQ4591P761::SmallRandom(std::vector<int8_t> &Output, std::unique_ptr<Prng::IPrng> &Rng)
{
	size_t i;
...
uint NTRUSQ4591P761::URandom32(std::unique_ptr<Prng::IPrng> &Rng)
{
...
void NTRUSQ4591P761::ZKeyGen(std::vector<byte> &Pk, std::vector<byte> &Sk, std::unique_ptr<Prng::IPrng> &Rng)
{
	// pk,sk = ZKeyGen() 
...
void NTRUSQ4591P761::ZDecrypt(std::vector<int8_t> &R, const std::vector<byte> &C, const std::vector<byte> &Sk)
{
	// r = ZDecrypt(C,sk)
...
void NTRUSQ4591P761::ZEncrypt(std::vector<byte> &C, const std::vector<int8_t> &R, const std::vector<byte> &Pk)
{
	// C = ZEncrypt(r,pk)
