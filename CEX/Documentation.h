...
The current version is <B>v1.0.0.7v</B> (A7 version), which are the major, minor, patch, and release codes, and the update segment letter. \n
\brief
...
<B>Current Release v1.0.0.7v (version A7):</B> \n
