...
/// <summary>
/// An implementation of an HMAC based pseudo random Generator (HMG)
/// </summary> 
/// 
/// <example>
/// <description>Generate an array of pseudo random bytes:</description>
/// <code>
/// HMG rnd(Digests::SHA512, [Providers::CSP]);
/// // initialize
...
public:
	...
	HMG(const HMG&) = delete;
	HMG& operator=(const HMG&) = delete;
	HMG& operator=(HMG&&) = delete;
