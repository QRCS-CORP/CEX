#ifndef _CEX_TRANSPOSE2_H
#define _CEX_TRANSPOSE2_H
...
public:
	...
	static void transpose_64x64_compact(std::vector<ulong> &out, std::vector<ulong> &in)
	{
	...
	static void transpose_8x64(std::vector<ulong> &in)
	{
		const ulong mask[3][2] =
		{
			{ 0X5555555555555555, 0XAAAAAAAAAAAAAAAA },
			{ 0X3333333333333333, 0XCCCCCCCCCCCCCCCC },
			{ 0X0F0F0F0F0F0F0F0F, 0XF0F0F0F0F0F0F0F0 },
