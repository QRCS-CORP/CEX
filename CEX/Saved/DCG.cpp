...
DCG::DCG(Digests DigestType, Providers ProviderType)
	...
	m_legalKeySizes(0),
	m_parallelProfile(m_msgDigest->BlockSize(), false, 4096, false),
...
const size_t DCG::ParallelBlockSize()
{
	return m_parallelProfile.ParallelBlockSize();
}

ParallelOptions &DCG::ParallelProfile()
{
...
void DCG::ParallelMaxDegree(size_t Degree)
{
