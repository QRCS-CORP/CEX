...
// Written by John G. Underhill, August 24, 2017
...
/// <summary>
/// An implementation of the SHA-3 Keccak sequential and parallel message-digests with a 1024-bit hash code
/// </summary>
///
/// <example>
...
/// <list type="bullet">
/// <item><description>The 1024bit version of Keccak is an extension, and should be considered as only for experimental use.</description></item>
/// <item><description>The 1024bit mode of Keccak uses a permutation with 48 rounds, twice the number of rounds as a standard Keccak trandform.</description></item>
...
/// </list>
/// </remarks>
class SHA31024 final : public IDigest
{
private:
	...
	class SHA31024State;
	std::vector<SHA31024State> m_dgtState;
...
public:
	...
	/// </summary>
	SHA31024(const SHA31024&) = delete;

	/// <summary>
	/// Copy operator: copy is restricted, this function has been deleted
	/// </summary>
	SHA31024& operator=(const SHA31024&) = delete;
	...
	explicit SHA31024(bool Parallel = false);
	...
	explicit SHA31024(KeccakParams &Params);
...
private:
	...
	static void HashFinal(std::vector<byte> &Input, size_t InOffset, size_t Length, SHA31024State &State);
	static void Permute(std::array<ulong, 25> &State);
	void ProcessLeaf(const std::vector<byte> &Input, size_t InOffset, SHA31024State &State, ulong Length);
};
