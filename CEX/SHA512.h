...
private:
	...
	static void HashFinal(std::vector<byte> &Input, size_t InOffset, size_t Length, SHA512State &State);
	static void Permute(const std::vector<byte> &Input, size_t InOffset, SHA512State &State);
