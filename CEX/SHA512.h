...
private:
	...
	static const size_t ITL_LANESIZE = 4;
	static const size_t ITL_BLKSIZE = BLOCK_SIZE * ITL_LANESIZE;
	static const ulong PRL_BRANCHSIZE = 1024 * 1000 * 10;
	static const ulong PRL_DEGREE = 4;
	static const ulong MAX_PRLBLOCK = 1024 * 1000 * PRL_DEGREE * 100;
	static const ulong MIN_PRLBLOCK = ITL_BLKSIZE * PRL_DEGREE;
