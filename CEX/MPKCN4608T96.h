...
#ifndef CEX_MPKCN4608T96_H
#define CEX_MPKCN4608T96_H
...
public:
	...
	/// </summary>
	static const size_t CIPHERTEXT_SIZE = 188;
	...
	/// The dimension: N
	/// </summary>
	static const uint32_t MPKC_N = 4608;

	/// <summary>
	/// The error correction capability of the code: T
	/// </summary>
	static const uint32_t MPKC_T = 96;

	/// <summary>
	/// The uint8_t size of the CCA private key polynomial
	/// </summary>
	static const size_t PRIVATEKEY_SIZE = 13608;

	/// <summary>
	/// The uint8_t size of the CCA public key polynomial
	/// </summary>
	static const size_t PUBLICKEY_SIZE = 524160;
