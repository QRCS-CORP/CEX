...
/// <code>
/// NewHope cpr(NewHopeParameters::RLWES1Q12289N1024);
...
/// <para>Ring learning with errors (NewHope) is the Learning With Errors problem (a generalization of the parity learning problem), specialized to polynomial rings over finite fields. \n
...
/// This makes NewHope a strong asymmetric cipher and resistant to currently known attack methods that could use quantum computers.</para>
///
/// <para>This implementation of NewHope uses the NewHope reconcilliation method, whereby the shared seed is generated by the receiver,
...
/// </list>
/// </remarks>
class NewHope final : public IAsymmetricCipher
{
private:
...
public:
	...
	/// </summary>
	NewHope(const NewHope&) = delete;

	/// <summary>
	/// Copy operator: copy is restricted, this function has been deleted
	/// </summary>
	NewHope& operator=(const NewHope&) = delete;
	...
	NewHope(NewHopeParameters Parameters = NewHopeParameters::RLWES1Q12289N1024, Prngs PrngType = Prngs::BCR);
	...
	NewHope(NewHopeParameters Parameters, IPrng* Prng);
	...
	/// </summary>
	const NewHopeParameters Parameters();
