...
/// <summary>
/// An [optionally] parallelized Threefish1024 stream cipher implementation
/// </summary>
/// 
/// <example>
...
public:
	...
	explicit Threefish1024(StreamAuthenticators Authenticator = StreamAuthenticators::None);
