...
/// <summary>
/// A vectorized and optionally parallelized Threefish1024 120-round stream cipher [TSX1024] implementation.
...
/// The supported MAC generator options for Threefish512 are HMAC(SHA2-256/512), and the Keccak based KMAC-256, KMAC-512, and the experimental KMAC-1024.</para>
///
/// <description>Implementation Notes:</description>
/// <list type="bullet">
/// <item><description></description></item>
/// <item><description>The Key size is 128 bytes (1024 bits).</description></item>
...
/// <item><description>Block size is 128 bytes wide (1024 bits).</description></item>
/// <item><description>Permutation rounds are fixed at 120.</description></item>
...
public:
	...
	/// The default authenticator parameter in Threefish-1024 is KMAC1024; valid options are, None, HMACSHA256, HMACSHA512, KMAC256, KMAC512, and KMAC1024.</para>
	/// </summary>
	/// 
