...
/// <code>
/// ModuleLWE asycpr(Enumeration::MLWEParams::Q12289N1024);
...
/// <para>Module learning with errors (MLWE) is the Learning With Errors problem (a generalization of the parity learning problem), specialized to polynomial rings over finite fields. \n
...
///
/// <para>This implementation of ModuleLWE uses the NewHope reconcilliation method, whereby the shared seed is generated by the receiver,
