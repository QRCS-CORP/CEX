...
// An implementation of an Rijndael-256 authenticated Counter Mode (QOT).
...
/// <summary>
/// An implementation of the Rijndael-based 512bit wide-block-cipher QOT, operating in a Little-Endian counter-mode, as an Authenticate, Encrypt,
/// and Additional Data (AEAD) stream cipher implementation (Rijndael-512 Cipher Stream). \n
/// <para>This is a fallback for the AES-NI implementation of this cipher QCS.
/// This cipher uses the KMAC-1024 authentication mode set through the constructor to authenticate the stream.</para>
/// </summary> 
/// 
/// <example>
...
/// QOT cipher(StreamAuthenticators::KMAC256);
...
/// <para>
/// The QOT symmetric cipher is a 256-bit wide-block Rijndael based, Authenticate, Encrypt, and Additional Data (AEAD) authenticated stream-cipher. \n
/// QOT has provable security, based on the Rijndael-256 permutation function used by this cipher. \n
/// QOT first encrypts the plain-text using a Little-Endian counter mode, then processes that cipher-text using a MAC function used for data authentication. \n
...
/// <para>The encryption and decryption functions of the QOT mode can be multi-threaded. This is achieved by processing multiple blocks of message input independently across threads. \n
/// The QOT stream cipher also leverages SIMD instructions to 'double parallelize' those segments. An input block assigned to a thread
...
/// <item><description>In authenticated mode, the internal keys generated by cSHAKE will be unique with each MAC generator, each authentication option should be considered a seperate and distinct variant of the cipher, for example, QOT256-SHAKE512 or QOT256-HMAC512</description></item>
...
/// </list>
/// </remarks>
class QOT final : public IStreamCipher
{
private:
	...
	static const std::vector<byte> QOT_INFO;
	static const size_t QOTX1_ROUNDS = 40;
	static const size_t QOTX2_ROUNDS = 80;
	static const size_t QOTX3_ROUNDS = 120;
	static const size_t STATE_PRECACHED = 2048;
	static const size_t STATE_THRESHOLD = 838;
	static const byte UPDATE_PREFIX = 0x80;

	class QotState;
	std::unique_ptr<QotState> m_qotState;
...
public:
	...
	/// </summary>
	QOT(const QOT&) = delete;

	/// <summary>
	/// Copy operator: copy is restricted, this function has been deleted
	/// </summary>
	QOT& operator=(const QOT&) = delete;
	...
	QOT(StreamAuthenticators AuthenticatorType = StreamAuthenticators::KMAC512);
...
private:
	...
	static void Finalize(std::unique_ptr<QotState> &State, std::unique_ptr<IMac> &Authenticator);
