...
public:
	...
	/// <param name="Message">A custom message or error data</param>
	explicit CryptoAuthenticationFailure(const std::string &Origin, const std::string &Message);
	...
	explicit CryptoAuthenticationFailure(const std::string &Origin, const std::string &Message, const std::string &Detail);
};
