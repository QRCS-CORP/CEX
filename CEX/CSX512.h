...
/// <item><description>The ParallelBlockSize() can be changed through the ParallelProfile() property, the initial size is calculated automatically based on the systems capabilities, and modifying this vale is not recommended</description></item>
/// </list>
/// 
...
public:
	...
	explicit CSX512(StreamAuthenticators AuthenticatorType = StreamAuthenticators::KMAC512);
...
private:
	...
	static void Generate(std::unique_ptr<CSX512State> &State, std::vector<byte> &Output, const size_t OutOffset, std::array<uint, 2> &Counter, const size_t Length);
