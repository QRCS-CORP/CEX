...
/// </list>
/// </remarks>
class SHA2256 final : public IDigest
{
private:
...
public:
	...
	/// </summary>
	SHA2256(const SHA2256&) = delete;

	/// <summary>
	/// Copy operator: copy is restricted, this function has been deleted
	/// </summary>
	SHA2256& operator=(const SHA2256&) = delete;
	...
	explicit SHA2256(bool Parallel = false);
	...
	explicit SHA2256(SHA2Params &Params);
