#ifndef CEXTEST_CSPTEST_H
#define CEXTEST_CSPTEST_H
...
namespace Test
{
	...
	/// <summary>
	/// Tests the system entropy provider output with random sampling analysis, and stress tests
	/// </summary>
	class CSPTest final : public ITest
	{
	private:
