...
namespace Test
{
	...
	void ACSTest::Initialize()
	{
		...
		{
			// acsc256h256
			std::string("33A24374A6DBAE9F03839E0D921936745C34A0677CB54153A09624C7B09E5819"),
			std::string("1D700C370117795704FFA81DB0918D938D124D16F89E4A9318BBEC799191BB19"),
			// acsc256k256
			...
			// acsc512h512
			std::string("97D9E2A2DBE2E108F0757C28CF9BA0D56540FE2C0529AF02E68CFEBAF58DE7DE975799FBC3652C3E12827084F589B8A97E1A7761A70619F4FC5D15296E87163B"),
			std::string("7C9B99F205BA1EF5B6012F6F909F18289C7E514449DCD6FBD2999749532D6BDD5515F21C4D7BD60075044FE668714662FF4A1D2524519121D451EF21EE0AB70F"),
			// acsc512k512
		...
		const std::vector<std::string> expected =
		{
			...
			std::string("15DE170E7E1076CC6E421C32AF9AB691"),	// acsc256h256
			std::string("7F97A702908E1EF4B9146DCF17D443B3"),	// acsc256k256
			std::string("99CCFB3DE4EF51CA71D56DF3741A16DF"),	// acsc512h512
		...
		const std::vector<std::string> monte =
		{
			...
			std::string("30DD7B43E7F77B1472EC0EAB10C8B1E4"),	// acsc256h256
			std::string("A0D8565A55EAC983B5468F13A03981C0"),	// acsc256k256
			std::string("8D0145C8F6B354536CCB028726829C32"),	// acsc512h512
