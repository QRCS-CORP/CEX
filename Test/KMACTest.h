...
namespace Test
{
	...
	private:
		...
		std::vector<std::vector<uint8_t>> m_custom;
	...
	public:
		...
		void Kat(IMac* Generator, std::vector<uint8_t> &Key, std::vector<uint8_t> &Custom, std::vector<uint8_t> &Message, std::vector<uint8_t> &Expected);
