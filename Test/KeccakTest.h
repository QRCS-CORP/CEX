...
namespace Test
{
	...
	public:
		...
		/// </remarks>
		void Kat256(std::vector<byte> &Message, std::vector<byte> &Expected);
		...
		/// ref(24, 448) : <see href = "https://www.di-mgt.com.au/sha_testvectors.html" / >
		/// </remarks>
		void Kat512(std::vector<byte> &Message, std::vector<byte> &Expected);
		...
		/// <param name="Message">The input message array</param>
		/// <param name="Expected">The expected known output</param>
		void Kat1024(std::vector<byte> &Message, std::vector<byte> &Expected);
