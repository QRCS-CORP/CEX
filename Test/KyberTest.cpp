...
namespace Test
{
	...
	std::string KyberTest::Run()
	{
		try
		{
			...
			Integrity();
			OnProgress(std::string("KyberTest: Passed NIST PQ Round 2 ciphertext, shared-secret, public and private key known answer tests.."));
			Kat();
			OnProgress(std::string("KyberTest: Passed NIST PQ Round 2 shared-secret known answer tests.."));
			PublicKey();
	...
	void KyberTest::Authentication()
	{
		...
		Kyber cpr1(KyberParameters::MLWES1Q3329N256);
		...
		Kyber cpr2(KyberParameters::MLWES2Q3329N256);
		...
		Kyber cpr3(KyberParameters::MLWES2Q3329N256);
	...
	void KyberTest::CipherText()
	{
		...
		// test param 3: MLWES3Q3329N256
		Kyber cpr3(KyberParameters::MLWES3Q3329N256);
		AsymmetricKeyPair* kp3 = cpr3.Generate();
	...
	void KyberTest::Integrity()
	{
		...
		Kyber cpr1(KyberParameters::MLWES1Q3329N256, &gen);
		AsymmetricKeyPair* kp1 = cpr1.Generate();
		...
		Kyber cpr2(KyberParameters::MLWES2Q3329N256, &gen);
		AsymmetricKeyPair* kp2 = cpr2.Generate();
		...
		Kyber cpr3(KyberParameters::MLWES3Q3329N256, &gen);
		AsymmetricKeyPair* kp3 = cpr3.Generate();
	...
	void KyberTest::Kat()
	{
		...
		for (i = 0; i < TSTCNT; ++i)
		{
			...
			Kyber cpr(KyberParameters::MLWES1Q3329N256, &gen);
		...
		for (i = 0; i < TSTCNT; ++i)
		{
			...
			Kyber cpr(KyberParameters::MLWES2Q3329N256, &gen);
			AsymmetricKeyPair* kp = cpr.Generate();
		...
		for (i = 0; i < TSTCNT; ++i)
		{
			...
			Kyber cpr(KyberParameters::MLWES3Q3329N256, &gen);
			AsymmetricKeyPair* kp = cpr.Generate();
	...
	void KyberTest::Exception()
	{
		...
		try
		{
			Kyber cpr(KyberParameters::MLWES2Q3329N256, Enumeration::Prngs::None);
		...
		try
		{
			Kyber cpr(KyberParameters::MLWES2Q3329N256, Enumeration::Prngs::BCR);
	...
	void KyberTest::PublicKey()
	{
		...
		pk1[0] += 1;
		pk1[1] += 1;
		AsymmetricKey* pk2 = new AsymmetricKey(pk1, AsymmetricPrimitives::Kyber, AsymmetricKeyTypes::CipherPublicKey, static_cast<AsymmetricParameters>(KyberParameters::MLWES1Q3329N256));
		cpr1.Initialize(pk2);
		cpr1.Encapsulate(cpt, sec1);
		...
		pk3[0] += 1;
		pk3[1] += 1;
		AsymmetricKey* pk4 = new AsymmetricKey(pk3, AsymmetricPrimitives::Kyber, AsymmetricKeyTypes::CipherPublicKey, static_cast<AsymmetricParameters>(KyberParameters::MLWES2Q3329N256));
		cpr2.Initialize(pk4);
		cpr2.Encapsulate(cpt, sec1);
		...
		pk5[0] += 1;
		pk5[1] += 1;
		AsymmetricKey* pk6 = new AsymmetricKey(pk5, AsymmetricPrimitives::Kyber, AsymmetricKeyTypes::CipherPublicKey, static_cast<AsymmetricParameters>(KyberParameters::MLWES3Q3329N256));
		cpr3.Initialize(pk6);
		cpr3.Encapsulate(cpt, sec1);
	...
	void KyberTest::Stress()
	{
		...
		Kyber cpr1(KyberParameters::MLWES2Q3329N256);
