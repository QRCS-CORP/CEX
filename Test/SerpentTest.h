    ...
    public:
		...
		virtual std::string Run()
        {
            try
            {
				...
				std::string rcnt = IntUtils::ToString(rcount);
				std::string klen = IntUtils::ToString((int)(keyStr.size() / 32));
				...
				rcnt = IntUtils::ToString(rcount);
				klen = IntUtils::ToString((int)(keyStr.size() / 32));
