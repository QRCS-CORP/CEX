#ifndef CEXTEST_RWSTEST_H
#define CEXTEST_RWSTEST_H
...
namespace Test
{
	...
	/// <summary>
	/// The RWS implementation KAT, monte carlo, stress, permutation, parallelization, authentication, and exception handling tests
	/// </summary>
	/// 
	/// <remarks>
	...
	/// </list>
	/// </remarks>
	class RWSTest final : public ITest
	{
	private:
