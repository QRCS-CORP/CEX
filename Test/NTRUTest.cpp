...
namespace Test
{
	...
	const std::string NTRUTest::DESCRIPTION = "NTRUPrime key generation, encryption, and decryption tests..";
	const std::string NTRUTest::SUCCESS = "SUCCESS! NTRUPrime tests have executed succesfully.";
	...
	void NTRUTest::Authentication()
	{
		...
		NTRUPrime cpr1(NTRUParameters::NTRUS2SQ4591N761);
		...
		NTRUPrime cpr2(NTRUParameters::NTRUS2SQ4591N761);
	...
	void NTRUTest::Exception()
	{
		...
		try
		{
			NTRUPrime cpr(NTRUParameters::None);
		...
		try
		{
			NTRUPrime cpr(NTRUParameters::None, Enumeration::Prngs::None);
		...
		try
		{
			NTRUPrime cpr(NTRUParameters::None, Enumeration::Prngs::BCR);
	...
	void NTRUTest::Integrity()
	{
		...
		NTRUPrime cpr1(NTRUParameters::NTRUS1SQ4621N653, &gen);
		...
		NTRUPrime cpr2(NTRUParameters::NTRUS2SQ4591N761, &gen);
		...
		NTRUPrime cpr3(NTRUParameters::NTRUS3SQ5167N857, &gen);
	...
	void NTRUTest::Kat()
	{
		...
		for (i = 0; i < TSTCNT; ++i)
		{
			...
			NTRUPrime cpr(NTRUParameters::NTRUS1SQ4621N653, &gen);
		...
		for (i = 0; i < TSTCNT; ++i)
		{
			...
			NTRUPrime cpr(NTRUParameters::NTRUS2SQ4591N761, &gen);
			AsymmetricKeyPair* kp = cpr.Generate();
		...
		for (i = 0; i < TSTCNT; ++i)
		{
			...
			NTRUPrime cpr(NTRUParameters::NTRUS3SQ5167N857, &gen);
			AsymmetricKeyPair* kp = cpr.Generate();
