...
namespace Test
{
	...
	std::string SkeinTest::Run()
	{
		try
		{
			...
			Kat(dgt256s, m_message[9], m_expected[3]);
			OnProgress(std::string("SkeinTest: Passed Skein-256 digest vector tests.."));

			Skein512* dgt512s = new Skein512();
			Kat(dgt512s, m_message[3], m_expected[4]);
			Kat(dgt512s, m_message[4], m_expected[5]);
			Kat(dgt512s, m_message[5], m_expected[6]);
			Kat(dgt512s, m_message[9], m_expected[7]);
			OnProgress(std::string("SkeinTest: Passed Skein-512 digest vector tests.."));

			Skein1024* dgt1024s = new Skein1024();
			Kat(dgt1024s, m_message[6], m_expected[8]);
			Kat(dgt1024s, m_message[7], m_expected[9]);
			Kat(dgt1024s, m_message[8], m_expected[10]);
			Kat(dgt1024s, m_message[9], m_expected[11]);
	...
	void SkeinTest::Initialize()
	{
		...
		HexConverter::Decode(message, 10, m_message);
		...
		const std::vector<std::string> expected =
		{
			...
			std::string("C8877087DA56E072870DAA843F176E9453115929094C3A40C463A196C29BF7BA"),
			...
			std::string("BC5B4C50925519C290CC634277AE3D6257212395CBA733BBAD37A4AF0FA06AF41FCA7903D06564FEA7A2D3730DBDB80C1F85562DFCC070334EA4D1D9E72CBA7A"),
			std::string("E62C05802EA0152407CDD8787FDA9E35703DE862A4FBC119CFF8590AFE79250BCCC8B3FAF1BD2422AB5C0D263FB2F8AFB3F796F048000381531B6F00D85161BC"
				"0FFF4BEF2486B1EBCD3773FABF50AD4AD5639AF9040E3F29C6C931301BF79832E9DA09857E831E82EF8B4691C235656515D437D2BDA33BCEC001C67FFDE15BA8"),
			std::string("1F3E02C46FB80A3FCD2DFBBC7C173800B40C60C2354AF551189EBF433C3D85F9FF1803E6D920493179ED7AE7FCE69C3581A5A2F82D3E0C7A295574D0CD7D217C"
				"484D2F6313D59A7718EAD07D0729C24851D7E7D2491B902D489194E6B7D369DB0AB7AA106F0EE0A39A42EFC54F18D93776080985F907574F995EC6A37153A578"),
			std::string("842A53C99C12B0CF80CF69491BE5E2F7515DE8733B6EA9422DFD676665B5FA42FFB3A9C48C217777950848CECDB48F640F81FB92BEF6F88F7A85C1F7CD1446C9"
				"161C0AFE8F25AE444F40D3680081C35AA43F640FD5FA3C3C030BCC06ABAC01D098BCC984EBD8322712921E00B1BA07D6D01F26907050255EF2C8E24F716C52A5"),
			std::string("0FFF9563BB3279289227AC77D319B6FFF8D7E9F09DA1247B72A0A265CD6D2A62645AD547ED8193DB48CFF847C06494A03F55666D3B47EB4C20456C9373C86297"
				"D630D5578EBD34CB40991578F9F52B18003EFA35D3DA6553FF35DB91B81AB890BEC1B189B7F52CB2A783EBB7D823D725B0B4A71F6824E88F68F982EEFC6D19C6")
		};
