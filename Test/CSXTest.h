#ifndef CEXTEST_CSXTEST_H
#define CEXTEST_CSXTEST_H
...
namespace Test
{
	...
	/// <summary>
	/// The CSX-512 implementations KAT, monte carlo, stress, permutation, parallelization, authentication, and exception handling tests
	/// </summary>
	/// 
	/// <remarks>
	...
	/// </list>
	/// </remarks>
	class CSXTest final : public ITest
	{
	private:
	...
	public:
		...
		/// <summary>
		/// Original known answer tests for CSX-512
		/// </summary>
		CSXTest();
