...
public:
	...
	/// </summary>
	/// 
	/// <param name="SeedType">The <see cref="CEX::Enumeration::SeedGenerators">Seed Generators</see> that supplies the seed material to the hash function</param>
	/// <param name="DigestType">The <see cref="CEX::Enumeration::Digests">Digest</see> type used to post-process the pseudo random seed material</param>
	...
	/// </summary>
	/// 
	/// <param name="PrngType">The <see cref="CEX::Enumeration::SeedGenerators">Seed generator</see> that supplies the seed material to the hash function</param>
	/// <param name="DigestType">The <see cref="CEX::Enumeration::Digests">Digest</see> type used to post-process the pseudo random seed material</param>
	...
	/// <summary>
	/// Reset the seed <see cref="CEX::Enumeration::SeedGenerators">Seed Generators</see> and the <see cref="CEX::Enumeration::Digests">Digest</see> engines
	/// </summary>
	void Reset();
