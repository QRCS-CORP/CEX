...
public:
	...
	KeyGenerator(Prngs PrngType = Prngs::CSPPrng, Digests DigestType = Digests::SHA512)
		:
		_ctrLength(0),
		_ctrVector(0),
		_dgtType(DigestType),
	...
	KeyGenerator(const Prngs PrngType, const Digests DigestType, const std::vector<byte> &Counter)
		:
...
protected:
	...
	IRandom* GetSeedEngine(Prngs PrngType);
